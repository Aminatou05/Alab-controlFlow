...
try {
  ...
  if (growthweek1 <= plantGrowth50) {
    ...
    console.log("week 1 growth status is : Pruned");
  }
  ...
  if (growthweek2 <= plantGrowth50) {
    ...
    console.log("week 2 growth status is : Pruned");
  }
  ...
  if (growthweek3 <= plantGrowth50) {
    ...
    console.log("week 3 growth status is : Pruned");
  }
} catch (error) {
...
// plant growth for 10 weeks without pruning
...
console.log(
  `Additional space required: ${additionalSpaceRequired} square meters`
);
